...
namespace UserInterface_Layer.Controllers
{
    ...
    public class AdoCollegeController : ControllerBase
    {
        ...
        public IActionResult GetAllUsers()
        {
            ...
            myConnection.ConnectionString = @"Data Source=MLI01139;Initial Catalog=Clg_Dept_Student_Db;User ID=sa;Password=***********;Integrated security=True;Trusted_Connection=True;TrustServerCertificate=True";

            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.Text;
            sqlCmd.CommandText = "Select * from College";
            ...
            {
                college = new College();
                college.Cid = Convert.ToInt32(reader.GetValue(0));
                college.Cname = reader.GetValue(1).ToString();
                college.Caddress= reader.GetValue(1).ToString(); ;
            }
            return college;
            myConnection.Close();
        }
        ...
        {
            string MyCommand = "Delete * from College where Cid=" + Id;
            SqlCommand myCommand = new SqlCommand(MyCommand, MainConnection);
            try
            {
